...
function GetUser({closeFunct, status}) {
  ...
  return (
	<div className='select-user-title-get-friend-details' ref={detailRef}>
		
		<motion.div className="s-u-t-g-f-d-inner" initial={{ opacity: 0, y: -20, scale:.5 }} animate={{ opacity: 1, y: 0, scale:1 }} 
