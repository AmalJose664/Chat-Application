...
import ShowProfile from './HomeUtils/ShowProfile.jsx';
...
const EachConversations = React.memo(({ value, i, type, isOnline,  })=>{
	...
	const setSelectedConvId = useSpecialStore(state => state.setSelectedConvId)
	...
	return (
		...
		<motion.div key={i} className={value.unread_count != 0 ? "home-user unread" : "home-user"}
			...
			<div className='home-user-cont' >
				...
				<div className="home-user-detail"
					onClick={() => changeUser(value, i, value.unread_count)}>
