...
function LoginComp() {
	...
	<div className='login-component'>
			<div className="content">
				<div className="text">
					<h1>Me Chat...... <Logo size={30} /> </h1>
				</div>
				<div className="power-text">
					<h1>By Me Chat<Logo size={30} /></h1>
				</div>
				<motion.div className="left" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, }}>
					
					<div className="grid">
						<GridView/>
					</div>
				</motion.div>
				<motion.div className="right-part" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, delay:.5}}>
					...
					<motion.div className="right lines" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, delay:1 }}>
						...
						<div className="form-content">
							< form onSubmit={handleSubmit} >
								<div className="input">
									<motion.input required type="email" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, delay: 1.2 }}
								...
								<div className="input">
									<motion.input required type={passShow ? 'text' : 'password'} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, delay: 1.2 }}
...
function GridView(){
	...
	return (
		<motion.div className="grid-content" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2,delay:.4 }}>
			{boxes.map((_, index) => {
					if (index == 17) {
						return (
